/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../tic-tac-toe-do/wrangler.jsonc --config=../../tests/chat-agent-e2e/wrangler.jsonc --config=../../tests/drizzle-durable-sqlite-test/wrangler.jsonc --config=../../tests/durable-sqlite-partial-sync-example/wrangler.jsonc --config=../../tests/durable-sqlite-sync-example/wrangler.jsonc --config=../../tests/socka-do-test/wrangler.jsonc --config=../../tests/websocket-do-test/wrangler.jsonc` (hash: 107931b7fe3199ea61e7d88f739c56a2)
// Runtime types generated with workerd@1.20260701.1 2025-10-01 
interface __BaseEnv_Env {
	CHAT_ROOM: DurableObjectNamespace<import("./src/worker").ChatRoomDO>;
}
