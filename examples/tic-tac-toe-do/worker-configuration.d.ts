/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../chatroom-do/wrangler.jsonc --config=../../tests/chat-agent-e2e/wrangler.jsonc --config=../../tests/drizzle-durable-sqlite-test/wrangler.jsonc --config=../../tests/durable-sqlite-partial-sync-example/wrangler.jsonc --config=../../tests/durable-sqlite-sync-example/wrangler.jsonc --config=../../tests/socka-do-test/wrangler.jsonc --config=../../tests/websocket-do-test/wrangler.jsonc` (hash: 746cf52513b4138b089df9a99e7fb00b)
// Runtime types generated with workerd@1.20260701.1 2025-10-01 
interface __BaseEnv_Env {
	TIC_TAC_TOE: DurableObjectNamespace<import("./src/worker").TicTacToeDO>;
}
