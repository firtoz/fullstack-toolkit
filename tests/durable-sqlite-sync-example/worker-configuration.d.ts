/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../../examples/chatroom-do/wrangler.jsonc --config=../../examples/tic-tac-toe-do/wrangler.jsonc --config=../chat-agent-e2e/wrangler.jsonc --config=../drizzle-durable-sqlite-test/wrangler.jsonc --config=../durable-sqlite-partial-sync-example/wrangler.jsonc --config=../socka-do-test/wrangler.jsonc --config=../websocket-do-test/wrangler.jsonc` (hash: 6cce529faf64a77a0e0cd535e6be221d)
// Runtime types generated with workerd@1.20260701.1 2025-10-01 
interface __BaseEnv_Env {
	TODO_SYNC: DurableObjectNamespace<import("./src/worker").TodoSyncDO>;
	VIRTUAL_PROPS_TS_DO: DurableObjectNamespace<import("./src/worker").VirtualPropsTanstackDO>;
	VIRTUAL_PROPS_DRIZZLE_DO: DurableObjectNamespace<import("./src/worker").VirtualPropsDrizzleDO>;
	VIRTUAL_PROPS_WS_TS_DO: DurableObjectNamespace<import("./src/worker").VirtualPropsWsTanstackDO>;
	VIRTUAL_PROPS_WS_DRIZZLE_DO: DurableObjectNamespace<import("./src/worker").VirtualPropsWsDrizzleDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "TodoSyncDO" | "VirtualPropsTanstackDO" | "VirtualPropsDrizzleDO" | "VirtualPropsWsTanstackDO" | "VirtualPropsWsDrizzleDO";
	}
