/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../../examples/chatroom-do/wrangler.jsonc --config=../../examples/tic-tac-toe-do/wrangler.jsonc --config=../chat-agent-e2e/wrangler.jsonc --config=../drizzle-durable-sqlite-test/wrangler.jsonc --config=../durable-sqlite-partial-sync-example/wrangler.jsonc --config=../durable-sqlite-sync-example/wrangler.jsonc --config=../websocket-do-test/wrangler.jsonc` (hash: e5192bc9498132cbaceb002214e65a50)
// Runtime types generated with workerd@1.20260701.1 2025-10-01 
interface __BaseEnv_Env {
	SOCKA_JSON_TEST: DurableObjectNamespace<import("./src/fixtures/worker").SockaJsonTestDO>;
	SOCKA_MSGPACK_TEST: DurableObjectNamespace<import("./src/fixtures/worker").SockaMsgpackTestDO>;
	SOCKA_SESSION_GAME_TEST: DurableObjectNamespace<import("./src/fixtures/worker").SockaSessionGameTestDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/fixtures/worker");
		durableNamespaces: "SockaJsonTestDO" | "SockaMsgpackTestDO" | "SockaSessionGameTestDO";
	}
