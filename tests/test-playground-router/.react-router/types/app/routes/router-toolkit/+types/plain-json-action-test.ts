...
type Module = typeof import("../plain-json-action-test.js")

type Info = GetInfo<{
  file: "routes/router-toolkit/plain-json-action-test.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../plain-json-action-test.js");
}];
