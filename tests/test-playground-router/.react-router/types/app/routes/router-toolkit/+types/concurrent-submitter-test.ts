...
type Module = typeof import("../concurrent-submitter-test.js")

type Info = GetInfo<{
  file: "routes/router-toolkit/concurrent-submitter-test.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../concurrent-submitter-test.js");
}];
