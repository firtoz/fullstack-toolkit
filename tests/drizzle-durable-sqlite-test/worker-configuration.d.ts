/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../../examples/chatroom-do/wrangler.jsonc --config=../../examples/tic-tac-toe-do/wrangler.jsonc --config=../chat-agent-e2e/wrangler.jsonc --config=../durable-sqlite-partial-sync-example/wrangler.jsonc --config=../durable-sqlite-sync-example/wrangler.jsonc --config=../socka-do-test/wrangler.jsonc --config=../websocket-do-test/wrangler.jsonc` (hash: 8937abf7af78b7c80ea0a0eb005e996a)
