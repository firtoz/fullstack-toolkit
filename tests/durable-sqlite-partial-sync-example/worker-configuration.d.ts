/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../../examples/chatroom-do/wrangler.jsonc -c ../../examples/tic-tac-toe-do/wrangler.jsonc -c ../chat-agent-e2e/wrangler.jsonc -c ../drizzle-durable-sqlite-test/wrangler.jsonc -c ../durable-sqlite-sync-example/wrangler.jsonc -c ../socka-do-test/wrangler.jsonc -c ../websocket-do-test/wrangler.jsonc` (hash: 6e54a3020afe813342194023f39e790d)
