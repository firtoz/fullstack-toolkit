/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../../examples/chatroom-do/wrangler.jsonc --config=../../examples/tic-tac-toe-do/wrangler.jsonc --config=../chat-agent-e2e/wrangler.jsonc --config=../drizzle-durable-sqlite-test/wrangler.jsonc --config=../durable-sqlite-sync-example/wrangler.jsonc --config=../socka-do-test/wrangler.jsonc --config=../websocket-do-test/wrangler.jsonc` (hash: 3db942d9026621f8df84b64e16112596)
// Runtime types generated with workerd@1.20260701.1 2025-10-01 
interface __BaseEnv_Env {
	PEOPLE_SYNC: DurableObjectNamespace<import("./src/worker").PeopleSyncDO>;
	EMOJI_GRID_SYNC: DurableObjectNamespace<import("./src/worker").EmojiGridSyncDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "PeopleSyncDO" | "EmojiGridSyncDO";
	}
