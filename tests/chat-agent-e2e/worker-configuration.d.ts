/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc --env-file .env.local` (hash: 640500e6fad28e0bb3da5c0e5fa7a0f3)
// Runtime types generated with workerd@1.20260116.0 2025-09-01 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTER_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "AI_GATEWAY_NAME" | "AI_GATEWAY_TOKEN" | "TEST_VAR">> {}
}
declare module "*.sql" {
	const value: string;
