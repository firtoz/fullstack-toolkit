/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../../examples/chatroom-do/wrangler.jsonc -c ../../examples/tic-tac-toe-do/wrangler.jsonc -c ../drizzle-durable-sqlite-test/wrangler.jsonc -c ../durable-sqlite-partial-sync-example/wrangler.jsonc -c ../durable-sqlite-sync-example/wrangler.jsonc -c ../socka-do-test/wrangler.jsonc -c ../websocket-do-test/wrangler.jsonc --env-file .env.local.example --env-file .env.local` (hash: 8f9dc025d252573e1e6572c560bcc652)
// Runtime types generated with workerd@1.20260415.1 2025-09-01 enable_ctx_exports,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "TestChatAgent";
	}
	interface Env {
		...
		TEST_CHAT_AGENT: DurableObjectNamespace<import("./src/worker").TestChatAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTER_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "AI_GATEWAY_NAME" | "AI_GATEWAY_TOKEN">> {}
}
declare module "*.sql" {
	const value: string;
