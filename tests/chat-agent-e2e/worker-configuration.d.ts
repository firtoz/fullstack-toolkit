/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../websocket-do-test/wrangler.jsonc --env-file .env.local.example --env-file .env.local` (hash: 8f9dc025d252573e1e6572c560bcc652)
