/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../chat-agent-e2e/wrangler.jsonc --env-file .env.local.example --env-file .env.local` (hash: 78ef8a2d412c23c6371bcc5409bbed6b)
// Runtime types generated with workerd@1.20260210.0 2025-10-01 
