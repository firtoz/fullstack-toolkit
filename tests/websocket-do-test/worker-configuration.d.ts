/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../chat-agent-e2e/wrangler.jsonc -c ../drizzle-durable-sqlite-test/wrangler.jsonc -c ../durable-sqlite-sync-example/wrangler.jsonc --env-file .env.local.example --env-file .env.local` (hash: 78ef8a2d412c23c6371bcc5409bbed6b)
