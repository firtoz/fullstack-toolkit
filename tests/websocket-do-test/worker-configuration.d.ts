/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 288f559cf049b1c97235bf998101b511)
// Runtime types generated with workerd@1.20251217.0 2025-10-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/test-fixtures/worker");
		durableNamespaces: "ChatRoomDO" | "ZodChatRoomDO" | "ZodChatRoomDO_JSON" | "ZodChatRoomDO_Dynamic" | "ZodChatRoomDO_CustomProtocolError";
	}
	interface Env {
		CHAT_ROOM: DurableObjectNamespace<import("./src/test-fixtures/worker").ChatRoomDO>;
		ZOD_CHAT_ROOM: DurableObjectNamespace<import("./src/test-fixtures/worker").ZodChatRoomDO>;
		ZOD_CHAT_ROOM_JSON: DurableObjectNamespace<import("./src/test-fixtures/worker").ZodChatRoomDO_JSON>;
		ZOD_CHAT_ROOM_DYNAMIC: DurableObjectNamespace<import("./src/test-fixtures/worker").ZodChatRoomDO_Dynamic>;
		ZOD_CHAT_ROOM_CUSTOM_ERROR: DurableObjectNamespace<import("./src/test-fixtures/worker").ZodChatRoomDO_CustomProtocolError>;
	}
}
