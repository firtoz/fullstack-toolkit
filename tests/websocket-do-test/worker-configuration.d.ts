/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../../examples/chatroom-do/wrangler.jsonc --config=../../examples/tic-tac-toe-do/wrangler.jsonc --config=../chat-agent-e2e/wrangler.jsonc --config=../drizzle-durable-sqlite-test/wrangler.jsonc --config=../durable-sqlite-partial-sync-example/wrangler.jsonc --config=../durable-sqlite-sync-example/wrangler.jsonc --config=../socka-do-test/wrangler.jsonc --env-file=.env.local.example` (hash: 0d9ebd66781fb89eeac7f4138a1bb434)
// Runtime types generated with workerd@1.20260701.1 2025-10-01 
interface __BaseEnv_Env {
	OPENROUTER_API_KEY: string;
	CLOUDFLARE_ACCOUNT_ID: string;
	AI_GATEWAY_NAME: string;
	AI_GATEWAY_TOKEN: string;
	CHAT_ROOM: DurableObjectNamespace<import("./src/websocket/test-fixtures/worker").ChatRoomDO>;
	SCHEMA_CHAT_ROOM: DurableObjectNamespace<import("./src/websocket/test-fixtures/worker").StandardSchemaChatRoomDO>;
	SCHEMA_CHAT_ROOM_JSON: DurableObjectNamespace<import("./src/websocket/test-fixtures/worker").StandardSchemaChatRoomDO_JSON>;
	SCHEMA_CHAT_ROOM_DYNAMIC: DurableObjectNamespace<import("./src/websocket/test-fixtures/worker").StandardSchemaChatRoomDO_Dynamic>;
	SCHEMA_CHAT_ROOM_CUSTOM_ERROR: DurableObjectNamespace<import("./src/websocket/test-fixtures/worker").StandardSchemaChatRoomDO_CustomProtocolError>;
	GATED_CHAT_ROOM: DurableObjectNamespace<import("./src/websocket/test-fixtures/worker").GatedChatRoomDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/websocket/test-fixtures/worker");
		durableNamespaces: "ChatRoomDO" | "StandardSchemaChatRoomDO" | "StandardSchemaChatRoomDO_JSON" | "StandardSchemaChatRoomDO_Dynamic" | "StandardSchemaChatRoomDO_CustomProtocolError" | "GatedChatRoomDO";
	}
