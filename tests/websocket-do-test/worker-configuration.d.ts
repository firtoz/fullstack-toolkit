/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../../examples/tic-tac-toe-do/wrangler.jsonc -c ../chat-agent-e2e/wrangler.jsonc -c ../drizzle-durable-sqlite-test/wrangler.jsonc -c ../durable-sqlite-partial-sync-example/wrangler.jsonc -c ../durable-sqlite-sync-example/wrangler.jsonc -c ../socka-do-test/wrangler.jsonc --env-file .env.local.example --env-file .env.local` (hash: 26cca14209a5073f1b61c4309672b283)
// Runtime types generated with workerd@1.20260317.1 2025-10-01 
