/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../../examples/chatroom-do/wrangler.jsonc -c ../../examples/tic-tac-toe-do/wrangler.jsonc -c ../chat-agent-e2e/wrangler.jsonc -c ../drizzle-durable-sqlite-test/wrangler.jsonc -c ../durable-sqlite-partial-sync-example/wrangler.jsonc -c ../durable-sqlite-sync-example/wrangler.jsonc -c ../socka-do-test/wrangler.jsonc --env-file .env.local.example` (hash: 8a48e77dc10159fca7bb59cd3c995ec1)
// Runtime types generated with workerd@1.20260430.1 2025-10-01 
