...
- [#70](https://github.com/firtoz/fullstack-toolkit/pull/70) [`7eb49ad`](https://github.com/firtoz/fullstack-toolkit/commit/7eb49adb100ffc5187a1f858b013b151db82643f) Thanks [@firtoz](https://github.com/firtoz)! - Initial release of **socka**: Standard Schema–first WebSocket RPC for browsers and servers (Node **`ws`**, Bun, Hono, Cloudflare Workers, and Cloudflare Durable Objects).
