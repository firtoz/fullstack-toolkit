...
- [`1d094ab`](https://github.com/firtoz/fullstack-toolkit/commit/1d094ab0ab0d065e8ba7afbe58c63d07dbb7204c) Thanks [@firtoz](https://github.com/firtoz)! - Ships as **4.0.0** (current published line is 3.x). This is a major bump within the 3.x API era, not a continuation of 2.x.
