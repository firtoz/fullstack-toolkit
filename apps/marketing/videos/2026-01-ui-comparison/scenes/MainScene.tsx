...
export const MainScene: React.FC<MainSceneProps> = ({
	...
	// Control positions (center of screen)
	const controlWidth = 260;
	const controlSpacing = 320;
	const centerX = 1920 / 2;
	const controlY = 300;

	// Calculate actual X positions of each control center
	const sliderX = centerX - controlSpacing; // 640
	const pickerX = centerX; // 960
	const stepperX = centerX + controlSpacing; // 1280
	...
	const knobRadius = 18;
	const sliderTrackTop = controlY + 30 + 64 + 24; // 418
	const sliderKnobY_21 = sliderTrackTop + 160; // Middle of 320px track
	const sliderKnobY_19 = sliderTrackTop + 320 - knobRadius; // Bottom bound

	// ScrollPicker: well is 480px, center at 240
	const pickerCenterY = controlY + 240;
	...
	const stepperUpY = controlY + 70;
	const stepperDownY = controlY + 410;
		...
		>
			...
			<div
				style={{
					...
					gap: controlSpacing - controlWidth, // 60px gap
