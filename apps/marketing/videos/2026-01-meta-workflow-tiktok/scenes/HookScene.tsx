...
export const HookScene: React.FC<SceneProps> = ({ markers }) => {
	...
	return (
		<AbsoluteFill style={{ backgroundColor: "#0f172a" }}>
			...
			<AbsoluteFill>
				<Img
					src={staticFile("2026-01-meta-workflow-tiktok/images/hook-bg.png")}
					style={{
						width: "100%",
						height: "100%",
						objectFit: "cover",
				...
				<div
					style={{
						...
						inset: 0,
						background:
							"radial-gradient(ellipse at center, rgba(15, 23, 42, 0.3) 0%, rgba(15, 23, 42, 0.6) 100%)",
					}}
				/>
			</AbsoluteFill>
			...
			>
				...
				>
					<span style={{ whiteSpace: "nowrap" }}>Direct a video</span> by{" "}
					<span
						style={{
