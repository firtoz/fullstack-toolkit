 ...
 * Description: "Prompt to Video" workflow - TikTok vertical format
 * Duration: ~40s
...
export const VIDEO_ID = "2026-01-meta-workflow-tiktok";

export const config: VideoConfig = {
	fps: 30,
	width: 1080,
	height: 1920,
	sceneGap: 0, // Fast paced
	sharedAudioId: "2026-01-meta-workflow", // Share audio with 16:9 version
};
...
export const codeSnippets = {
	processCommand: `bun run process-video 2026-01-meta-workflow-tiktok liam energetic`,
