...
export const CTAScene: React.FC<SceneProps> = ({ markers }) => {
	...
	return (
		<AbsoluteFill style={{ backgroundColor: "#000" }}>
			...
			{/* Foreground: The Video Result (AFTER) - fades in as "video" word ends */}
			<AbsoluteFill
				style={{
			...
			>
				<Img
					src={staticFile("2026-01-meta-workflow/images/video-result.png")}
					style={{
						width: "100%",
						height: "100%",
						objectFit: "cover",
			...
			>
				...
				>
					...
					>
						...
						<span>github.com/firtoz/fullstack-toolkit</span>
					</div>
				</div>
			</AbsoluteFill>
		</AbsoluteFill>
